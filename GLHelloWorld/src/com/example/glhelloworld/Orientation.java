...
public class Orientation {
	...
	Vector3 GetForwardWorldCoords() {
		...
		m_ForwardWorldVec
				.Set(ForwardWorld[0], ForwardWorld[1], ForwardWorld[2]);
	...
	void SetPositionMatrix(Vector3 position) {
		...
		Matrix.translateM(m_PositionMatrix, 0, position.x, position.y,
				position.z);
	}
	...
	void AddRotation(float AngleIncrementDegrees) {
		...
		// y, z)
		Matrix.rotateM(m_RotationMatrix, 0, AngleIncrementDegrees,
	...
	/******** Create General Matrix for Updating Objects *********/
	...
	float[] UpdateOrientation() {
		...
		Matrix.multiplyMM(TempMatrix, 0, m_PositionMatrix, 0, m_RotationMatrix,
				0);

		// Scale Object first
		Matrix.multiplyMM(m_OrientationMatrix, 0, TempMatrix, 0, m_ScaleMatrix,
				0);
