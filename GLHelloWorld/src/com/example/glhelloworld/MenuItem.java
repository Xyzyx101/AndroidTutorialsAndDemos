...
public class MenuItem extends BillBoard {
	...
	float[] GetObject3dWindowCoords(int ViewPortWidth, int ViewPortHeight,
			Vector3 ObjOffset) {
		float[] WindowCoords;
		int[] View = new int[4];
		...
		// Log.d("DEBUG - In ProcessTouch() - VIEWPORT WIDTH,HEIGHT - ", ": " +
		// View[2] + ", " + View[3]);
		// Log.d("DEBUG - In ProcessTouch() - Object Window Coords (x,y,z) = ",
		// WindowCoords[0] + ", " + WindowCoords[1] + "," + WindowCoords[2]);

		return WindowCoords;
	}

	boolean Touched(float TouchX, float TouchY, int ViewPortWidth,
			int ViewPortHeight) {
		...
		float[] UpperLeft = GetObject3dWindowCoords(ViewPortWidth,
				ViewPortHeight, ObjCoordsUpperLeft);
		float[] UpperRight = GetObject3dWindowCoords(ViewPortWidth,
				ViewPortHeight, ObjCoordsUpperRight);
		float[] LowerLeft = GetObject3dWindowCoords(ViewPortWidth,
				ViewPortHeight, ObjCoordsLowerLeft);
