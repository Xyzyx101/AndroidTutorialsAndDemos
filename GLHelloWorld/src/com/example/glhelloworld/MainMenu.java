...
enum MenuStates {
	None, NewGame, ContinueCurrentGame, HighScoreTable, Copyright
}
...
public class MainMenu {
	...
	MenuStates GetMainMenuStatus(float TouchX, float TouchY, int ViewPortWidth,
			int ViewPortHeight) {
		...
		// New Game Menu Item
		Touched = m_NewGameItem.Touched(TouchX, TouchY, ViewPortWidth,
				ViewPortHeight);
		if (Touched) {
		...
		Touched = m_ContinueGameItem.Touched(TouchX, TouchY, ViewPortWidth,
				ViewPortHeight);
		if (Touched) {
		...
		Touched = m_HighScoresItem.Touched(TouchX, TouchY, ViewPortWidth,
				ViewPortHeight);
		if (Touched) {
		...
		// CopyRight Menu Item
		Touched = m_CopyRightItem.Touched(TouchX, TouchY, ViewPortWidth,
				ViewPortHeight);
		if (Touched) {
