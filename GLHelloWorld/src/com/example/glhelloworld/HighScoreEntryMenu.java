...
enum EntryMenuStates {
	None, NextCharacterPressed, PreviousCharacterPressed, Enter
}
...
public class HighScoreEntryMenu {
	...
	void ResetMenu() {
		...
		m_Text.RenderToBillBoard(m_HighScoreEntryMenuImage,
				m_CurrentEntryPositionX, m_CurrentEntryPositionY);
	...
	void RenderEntryToMenu() {
		...
		RenderTextToMenu(StringCharacter, m_CurrentEntryPositionX,
	...
	EntryMenuStates GetEntryMenuStatus(float TouchX, float TouchY,
		...
		Touched = m_NextCharacterButton.Touched(TouchX, TouchY, ViewPortWidth,
				ViewPortHeight);
		if (Touched) {
		...
		Touched = m_PreviousCharacterButton.Touched(TouchX, TouchY,
		...
		// Enter Menu Item
		Touched = m_EnterButton.Touched(TouchX, TouchY, ViewPortWidth,
				ViewPortHeight);
		if (Touched) {
