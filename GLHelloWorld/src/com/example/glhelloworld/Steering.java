...
public class Steering {
	...
	void SetSteeringHorizontal(HorizontalSteeringValues Horizontal,
			float TurnDelta) {
	...
	void SetSteeringSpeed(SpeedSteeringValues Speed, float MaxSpeed,
			float MinSpeed, float SpeedDelta) {
